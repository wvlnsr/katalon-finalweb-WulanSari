...
WebUI.waitForElementVisible(findTestObject('home-page/login-modal/popup'), 2)

WebUI.verifyElementPresent(findTestObject('home-page/login-modal/register-btn'), 0)

WebUI.click(findTestObject('home-page/login-modal/register-btn'))

WebUI.setText(findTestObject('register-page/username-field'), 'hasbullah')
